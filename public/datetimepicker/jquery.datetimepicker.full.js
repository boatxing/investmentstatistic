		...
		createDateTimePicker = function (input) {
			...
			datetimepicker
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						//快速选择23:59:59
                        time += '<div class="xdsoft_time ' + classes.join(' ') + '" data-hour="23" data-minute="59" data-seconds="59">23:59:59</div>';
			...
			timebox
				.on('touchend click.xdsoft', 'div', function (xdevent) {
					...
					//快速选择23:59:59
					if($this.data('seconds'))currentTime.setSeconds($this.data('seconds'));
					datetimepicker.trigger('select.xdsoft', [currentTime]);
